...
define([
    ...
    'd3',
    'd3-scale'
], function ($, Handlebars, template, Topology, modalTemplate, tokenUtils, ajaxUtils, errorUtils, d3, d3scale) {
    ...
    return function (config) {
        ...
        this.init = function () {
            var ajax_options = ajaxUtils.getAjaxOptions(config.cluster);
            ajax_options.type = "GET";
            ajax_options.url = config.cluster.api.url + config.cluster.api.path + '/topology';
            ajax_options.success = function (topologyDatas) {
                  ...
                  //  color = d3.scale.category20();
                    color = d3scale.scaleOrdinal(d3scale.schemeCategory20);
